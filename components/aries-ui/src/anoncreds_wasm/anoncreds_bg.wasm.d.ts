...
export function anoncreds_get_current_error(a: number): number;
export function anoncreds_object_free(a: number): void;
export function anoncredsObjectGetTypeName(a: number): number;
export function anoncreds_credential_from_json(a: number): number;
...
export function anoncredsCreateLinkSecret(): number;
export function anoncredsCreateCredentialRequest(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number): void;
export function anoncreds_credential_get_attribute(a: number, b: number, c: number, d: number): void;
export function anoncreds_schema_from_json(a: number): number;
export function anoncreds_credential_request_from_json(a: number): number;
export function anoncreds_credential_request_metadata_from_json(a: number): number;
export function anoncreds_presentation_from_json(a: number): number;
export function anoncreds_presentation_request_from_json(a: number): number;
export function anoncreds_credential_offer_from_json(a: number): number;
export function anoncreds_credential_definition_from_json(a: number): number;
export function anoncreds_credential_definition_private_from_json(a: number): number;
export function anoncreds_key_correctness_proof_from_json(a: number): number;
export function take_pointer_by_value(a: number, b: number): void;
export function anoncreds_object_get_json(a: number, b: number): void;
export function return_pointer(): number;
export function anoncreds_process_credential(a: number, b: number, c: number, d: number, e: number, f: number, g: number): void;
...
export function anoncredsCreateCredentialDefinitionFromJson(a: number): number;
export function anoncredsCreateCredentialOfferFromJson(a: number): number;
export function anoncredsValidateCredentialDefinitionFromJson(a: number, b: number): void;
export function __wbg_wasmcredentialentry_free(a: number): void;
export function __wbg_wasmcredentialprove_free(a: number): void;
export function anoncredsCreatePresentation(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number): void;
