...
* @returns {any}
*/
export function anoncredsObjectGetTypeName(p: number): any;
/**
* @param {any} json
* @returns {number}
*/
export function anoncreds_credential_from_json(json: any): number;
/**
* @returns {number}
*/
...
* @returns {any}
*/
export function anoncredsCreateLinkSecret(): any;
/**
...
* @returns {any}
*/
export function anoncredsCreateCredentialRequest(entropy: string, prover_did: string, cred_def_p: number, link_secret: string, link_secret_id: string, cred_offer_p: number): any;
/**
* @param {number} handle
* @param {string} name
* @returns {any}
*/
export function anoncreds_credential_get_attribute(handle: number, name: string): any;
/**
* @param {any} json
* @returns {number}
*/
export function anoncreds_schema_from_json(json: any): number;
/**
* @param {any} json
* @returns {number}
*/
export function anoncreds_credential_request_from_json(json: any): number;
/**
* @param {any} json
* @returns {number}
*/
export function anoncreds_credential_request_metadata_from_json(json: any): number;
/**
* @param {any} json
* @returns {number}
*/
export function anoncreds_presentation_from_json(json: any): number;
/**
* @param {any} json
* @returns {number}
*/
export function anoncreds_presentation_request_from_json(json: any): number;
/**
* @param {any} json
* @returns {number}
*/
export function anoncreds_credential_offer_from_json(json: any): number;
/**
* @param {any} json
* @returns {number}
*/
export function anoncreds_credential_definition_from_json(json: any): number;
/**
* @param {any} json
* @returns {number}
*/
export function anoncreds_credential_definition_private_from_json(json: any): number;
/**
* @param {any} json
* @returns {number}
*/
export function anoncreds_key_correctness_proof_from_json(json: any): number;
/**
* @param {number} p
* @returns {any}
*/
export function take_pointer_by_value(p: number): any;
/**
* @param {number} p
* @returns {any}
*/
export function anoncreds_object_get_json(p: number): any;
/**
* @returns {number}
*/
export function return_pointer(): number;
/**
* @param {number} cred_p
...
* @returns {any}
*/
export function anoncreds_process_credential(cred_p: number, cred_req_metadata_p: number, link_secret: string, cred_def_p: number, rev_reg_def_p: number): any;
/**
...
* @returns {any}
*/
export function anoncredsCreateCredentialDefinitionFromJson(json: any): any;
/**
* @param {any} json
* @returns {any}
*/
export function anoncredsCreateCredentialOfferFromJson(json: any): any;
/**
* @param {any} json
* @returns {boolean}
*/
...
* @returns {any}
*/
export function anoncredsCreatePresentation(pres_req_p: number, credentials: any, credentials_prove: any, self_attest_names: any[], self_attest_values: any[], link_secret: string, schemas: Uint32Array, schema_ids: any[], cred_defs: Uint32Array, cred_def_ids: any[]): any;
/**
*/
